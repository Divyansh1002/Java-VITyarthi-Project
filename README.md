...
A simple, clean, console-based Java application to manage students, courses, grades, and academic records.
...
* **JVM (Java Virtual Machine):** It is an abstract machine that provides a runtime environment to execute Java bytecode.
* **JRE (Java Runtime Environment):** It includes the JVM and core libraries needed to run the Java applications.
